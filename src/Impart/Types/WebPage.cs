...
namespace Impart
{
    ...
    public class WebPage
    {
        ...
        protected void Render()
        {
            ...
            + $"{textBuilder.Replace("%^", $"{Environment.NewLine}    ").ToString()}{Environment.NewLine}    </body>{Environment.NewLine}</html>");
            Common.Change(cssPath, styleBuilder.Replace("%^", Environment.NewLine).ToString());
        }
    }
}