...
namespace Impart
{
    ...
    public class WebPage
    {
        ...
        {
            return $"<!-- Generated by Impart - https://github.com/PixelatedLagg/Impart --><!DOCTYPE html><html xmlns=\"http://www.w3.org/1999/xhtml\"><style>{styleBuilder.Append($"* {{padding: 0;margin: {defaultMargin};}}").ToString()}</style><body>{textBuilder.ToString()}</body></html>";
        }
    }
}